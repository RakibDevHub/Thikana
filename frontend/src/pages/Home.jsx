        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md dark:shadow-gray-700">
              ...
              <h3 className="text-xl font-semibold mb-2 dark:text-white">Trusted Since 2024</h3>
            ...
            <div className="text-center p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md dark:shadow-gray-700">
              <div className="text-5xl mb-4">🔍</div>
              <h3 className="text-xl font-semibold mb-2 dark:text-white">Best Selection</h3>
              <p className="text-gray-600 dark:text-gray-300">
            ...
            <div className="text-center p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md dark:shadow-gray-700">
              <div className="text-5xl mb-4">🤝</div>
              <h3 className="text-xl font-semibold mb-2 dark:text-white">Expert Guidance</h3>
              <p className="text-gray-600 dark:text-gray-300">
